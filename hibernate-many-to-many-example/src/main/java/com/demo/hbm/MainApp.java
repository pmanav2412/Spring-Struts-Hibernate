...
public class MainApp {
   public static void main(String[] args) {
      ...
      try {
         ...
         Address address3 = new Address("Ahemdabad", "Gujarat", "India","392011");
         // Employee1 have 2 addresses
         Employee employee1 = new Employee("Ravindraaa Singh", "Sales Manager", 450000);
         employee1.getAddresses().add(address1);
         employee1.getAddresses().add(address2);

         // Employee2 have 1 address
         Employee employee2 = new Employee("Mohitaa Sharma", "Software Engineer", 850000);
