   ...
   public static SessionFactory getSessionFactory() {
      if (sessionFactory == null) {
         try {
            ...
            settings.put("hibernate.connection.url", "jdbc:mysql://localhost:3306/Employees?useLegacyDatetimeCode=false&serverTimezone=UTC");
            ...
            if (registry != null) {
            	System.out.println("ajjjjj null chhe");
